...
import { deleteJobs, updateJobs } from '@/app/_lib/_jobs/actions';

// import { deleteJobs, updateJobs } from '../_lib/actions';
// import { Job } from '@/types/types-jobs';
// import { jobs } from '@/db/constent';

interface JobsTableFloatingBarProps {
  table: Table<Job>;
}

export function JobsTableFloatingBar({ table }: JobsTableFloatingBarProps) {
