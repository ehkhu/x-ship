...
interface JobsTableContextProps {
  featureFlags: FeatureFlagValue[];
  setFeatureFlags: React.Dispatch<React.SetStateAction<FeatureFlagValue[]>>;
}

const JobsTableContext = React.createContext<JobsTableContextProps>({
  featureFlags: [],
  setFeatureFlags: () => {},
});
...
export function JobsTableProvider({ children }: React.PropsWithChildren) {
