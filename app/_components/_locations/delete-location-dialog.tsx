...
interface DeleteLocationsDialogProps
  ...
  locations: Row<Location>['original'][];
  showTrigger?: boolean;
  onSuccess?: () => void;
}

export function DeleteLocationsDialog({
  locations,
  showTrigger = true,
  onSuccess,
  ...props
}: DeleteLocationsDialogProps) {
  ...
  function onDelete() {
    ...
    startDeleteTransition(async () => {
      ...
      const { error } = await deleteLocations({
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {locations.length === 1 ? ' location' : ' locations'} from our
              servers.
            </DialogDescription>
          </DialogHeader>
