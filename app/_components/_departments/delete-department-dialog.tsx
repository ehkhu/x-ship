...
import { deleteDepartments } from '@/app/_lib/_departments/actions';
...
export function DeleteDepartmentsDialog({
  ...
  function onDelete() {
    ...
    startDeleteTransition(async () => {
      ...
      const { error } = await deleteDepartments({
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {departments.length === 1 ? ' department' : ' departments'} from
              our servers.
            </DialogDescription>
          </DialogHeader>
      ...
      <DrawerContent>
        <DrawerHeader>
          ...
          <DrawerDescription>
            This action cannot be undone. This will permanently delete your{' '}
            <span className="font-medium">{departments.length}</span>
            {departments.length === 1 ? ' department' : ' departments'} from our
            servers.
          </DrawerDescription>
        </DrawerHeader>
